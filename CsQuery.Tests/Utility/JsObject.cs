...
namespace CsQuery.Tests.Utility
{
    ...
    public class JsObject_ : CsQueryTest
    {
        ...
        {
            dynamic obj = new JsObjectWrapper(Objects.Dict2Dynamic<JsObject>(testDict));
            ...
            Assert.AreEqual("sub value 1", ((dynamic)new JsObjectWrapper(obj.prop4)).subprop1, "Subproperty is accessible and correct");

            string json = JSON.ToJSON(obj);
            dynamic back = new JsObjectWrapper(json.ParseJSON() as JsObject);
            Assert.AreEqual("sub value 1", ((dynamic)new JsObjectWrapper(back.prop4)).subprop1, "Subproperty is accessible and correct");
        ...
        public void JsObjectProperties()
        {
            ...
            dynamic obj = new JsObjectWrapper(jsObj);
            obj.someProp = "test";
