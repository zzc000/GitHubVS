...
namespace CsQuery
{
    ...
    /// 
    /// </summary>
    public class JsObjectWrapper : DynamicObject, 
        ...
        IEnumerable<KeyValuePair<string, object>>, IEnumerable
    {
        ...
        {
            InnerProperties = jsObject.InnerProperties;
            AllowMissingProperties = true;
            MissingPropertyValue = null;
        }

        public JsObjectWrapper(IDictionary<string, object> iDict)
        {
            InnerProperties = iDict;
            AllowMissingProperties = true;
            MissingPropertyValue = null;
        }
        ...
        protected bool TrySetMember(string name, object value)
        {
            try
            {
                ...
                {
                    InnerProperties[name] = new JsObjectWrapper((value as JsObject).InnerProperties);
                }
                else
                {
