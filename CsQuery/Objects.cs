...
namespace CsQuery
{
    ...
    public static class Objects
    {
        ...
        public static T Dict2Dynamic<T>(IDictionary<string, object> obj) where T : new()
        {
        ...
        private static object ConvertDeserializedValue<T>(object value, bool convertDates) where T : new()
        {
        ...
        public static T Dict2Dynamic<T>(IDictionary<string, object> obj, bool convertDates) where T : new()
        {
            T returnObj = new T();
            if (obj != null)
            {
        ...
        public static T ToExpando<T>(object source) where T : IDictionary<string, object>, new()
        {
        ...
        public static T ToExpando<T>(object source, bool deep) where T : IDictionary<string, object>, new()
        {
        ...
        public static T ToExpando<T>(object source, bool deep, IEnumerable<Type> ignoreAttributes) where T : IDictionary<string, object>, new()
        {
        ...
        /// <returns></returns>
        private static T ToNewExpando<T>(object source, bool deep, IEnumerable<Type> ignoreAttributes) where T : IDictionary<string, object>, new()
        {
            if (source == null)
            {
                return default(T);
